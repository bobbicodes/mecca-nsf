...
var G__14594 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__14594,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__14594;
}
});
...
var len__4531__auto___14599 = arguments.length;
var i__4532__auto___14600 = (0);
while(true){
if((i__4532__auto___14600 < len__4531__auto___14599)){
args__4534__auto__.push((arguments[i__4532__auto___14600]));

var G__14601 = (i__4532__auto___14600 + (1));
i__4532__auto___14600 = G__14601;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq14596){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__14597,G__14598,seq14596__$2);
});
...
var map__14603 = m;
var map__14603__$1 = ((((!((map__14603 == null)))?(((((map__14603.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__14603.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__14603):map__14603);
var file = cljs.core.get.call(null,map__14603__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__14603__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__14603__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__14603,map__14603__$1,file,line,column){
return (function (p1__14602_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__14602_SHARP_));
});})(map__14603,map__14603__$1,file,line,column))
...
var temp__5457__auto___14607 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___14607)){
var message_14608 = temp__5457__auto___14607;
cljs.core.println.call(null,message_14608);
} else {
}
...
var output_dir__$1 = (function (){var G__14609 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__14609),"/"].join('');
} else {
return G__14609;
}
})();
...
var G__14611 = exception.stack;
var G__14611__$1 = (((G__14611 == null))?null:clojure.string.split_lines.call(null,G__14611));
var G__14611__$2 = (((G__14611__$1 == null))?null:cljs.core.get.call(null,G__14611__$1,depth));
if((G__14611__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__14611__$2);
}
} else {
...
var vec__14612 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__14612,(0),null);
var column = cljs.core.nth.call(null,vec__14612,(1),null);
var vec__14615 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__14615,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__14615,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__14615,(2),null);
...
var m__$1 = (function (){var G__14618 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__14622 = (function (){var G__14621 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__14621);
} else {
return G__14621;
}
})();
...
return cljs.core.vary_meta.call(null,G__14623,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__14627 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__14627,(0),null);
var types = vec__14627;
...
return cljs.core.map.call(null,(function (p__14630){
var vec__14631 = p__14630;
var ns = cljs.core.nth.call(null,vec__14631,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__14631,(1),null);
return ((function (vec__14631,ns,vars__$1){
return (function (){
...
var G__14634 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
var G__14634__$1 = (((G__14634 instanceof cljs.core.Keyword))?G__14634.fqn:null);
switch (G__14634__$1) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__14634,G__14634__$1,env,once_fixtures,each_fixtures,vec__14631,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__14634,G__14634__$1,env,once_fixtures,each_fixtures,vec__14631,ns,vars__$1){
return (function (){
var seq__14635 = cljs.core.seq.call(null,vars__$1);
var chunk__14636 = null;
var count__14637 = (0);
var i__14638 = (0);
while(true){
if((i__14638 < count__14637)){
var v = cljs.core._nth.call(null,chunk__14636,i__14638);
var temp__5457__auto___14640 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___14640)){
var t_14641 = temp__5457__auto___14640;
each_fixture_fn.call(null,((function (seq__14635,chunk__14636,count__14637,i__14638,t_14641,temp__5457__auto___14640,v,each_fixture_fn,G__14634,G__14634__$1,env,once_fixtures,each_fixtures,vec__14631,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_14641)));
});})(seq__14635,chunk__14636,count__14637,i__14638,t_14641,temp__5457__auto___14640,v,each_fixture_fn,G__14634,G__14634__$1,env,once_fixtures,each_fixtures,vec__14631,ns,vars__$1))
);
} else {
}


var G__14642 = seq__14635;
var G__14643 = chunk__14636;
var G__14644 = count__14637;
var G__14645 = (i__14638 + (1));
seq__14635 = G__14642;
chunk__14636 = G__14643;
count__14637 = G__14644;
i__14638 = G__14645;
continue;
} else {
var temp__5457__auto__ = cljs.core.seq.call(null,seq__14635);
if(temp__5457__auto__){
var seq__14635__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__14635__$1)){
var c__4351__auto__ = cljs.core.chunk_first.call(null,seq__14635__$1);
var G__14646 = cljs.core.chunk_rest.call(null,seq__14635__$1);
var G__14647 = c__4351__auto__;
var G__14648 = cljs.core.count.call(null,c__4351__auto__);
var G__14649 = (0);
seq__14635 = G__14646;
chunk__14636 = G__14647;
count__14637 = G__14648;
i__14638 = G__14649;
continue;
} else {
var v = cljs.core.first.call(null,seq__14635__$1);
var temp__5457__auto___14650__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___14650__$1)){
var t_14651 = temp__5457__auto___14650__$1;
each_fixture_fn.call(null,((function (seq__14635,chunk__14636,count__14637,i__14638,t_14651,temp__5457__auto___14650__$1,v,seq__14635__$1,temp__5457__auto__,each_fixture_fn,G__14634,G__14634__$1,env,once_fixtures,each_fixtures,vec__14631,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_14651)));
});})(seq__14635,chunk__14636,count__14637,i__14638,t_14651,temp__5457__auto___14650__$1,v,seq__14635__$1,temp__5457__auto__,each_fixture_fn,G__14634,G__14634__$1,env,once_fixtures,each_fixtures,vec__14631,ns,vars__$1))
);
} else {
}


var G__14652 = cljs.core.next.call(null,seq__14635__$1);
var G__14653 = null;
var G__14654 = (0);
var G__14655 = (0);
seq__14635 = G__14652;
chunk__14636 = G__14653;
count__14637 = G__14654;
i__14638 = G__14655;
continue;
}
} else {
...
});})(each_fixture_fn,G__14634,G__14634__$1,env,once_fixtures,each_fixtures,vec__14631,ns,vars__$1))
);
});})(each_fixture_fn,G__14634,G__14634__$1,env,once_fixtures,each_fixtures,vec__14631,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__14634__$1)].join('')));

}
})());
});
;})(vec__14631,ns,vars__$1))
