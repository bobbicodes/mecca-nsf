...
var G__13334 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__13334,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__13334;
}
});
...
var len__4531__auto___13339 = arguments.length;
var i__4532__auto___13340 = (0);
while(true){
if((i__4532__auto___13340 < len__4531__auto___13339)){
args__4534__auto__.push((arguments[i__4532__auto___13340]));

var G__13341 = (i__4532__auto___13340 + (1));
i__4532__auto___13340 = G__13341;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq13336){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__13337,G__13338,seq13336__$2);
});
...
var file = cljs.core.get.call(null,map__13343__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__13343__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__13343__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__13343,map__13343__$1,file,line,column){
return (function (p1__13342_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__13342_SHARP_));
});})(map__13343,map__13343__$1,file,line,column))
...
var temp__5457__auto___13345 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___13345)){
var message_13346 = temp__5457__auto___13345;
cljs.core.println.call(null,message_13346);
} else {
}
...
var temp__5457__auto___13347 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5457__auto___13347)){
var message_13348 = temp__5457__auto___13347;
cljs.core.println.call(null,message_13348);
} else {
}
...
var output_dir__$1 = (function (){var G__13349 = output_dir;
if(!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/"))){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__13349),"/"].join('');
} else {
return G__13349;
}
})();
...
var G__13351 = exception.stack;
var G__13351__$1 = (((G__13351 == null))?null:clojure.string.split_lines.call(null,G__13351));
var G__13351__$2 = (((G__13351__$1 == null))?null:cljs.core.get.call(null,G__13351__$1,depth));
if((G__13351__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__13351__$2);
}
} else {
...
var vec__13352 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__13352,(0),null);
var column = cljs.core.nth.call(null,vec__13352,(1),null);
var vec__13355 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__13355,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__13355,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__13355,(2),null);
...
var m__$1 = (function (){var G__13358 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__13362 = (function (){var G__13361 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__13361);
} else {
return G__13361;
}
})();
...
return cljs.core.vary_meta.call(null,G__13363,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__13367 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__13367,(0),null);
var types = vec__13367;
...
return cljs.core.map.call(null,(function (p__13370){
var vec__13371 = p__13370;
var ns = cljs.core.nth.call(null,vec__13371,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__13371,(1),null);
return ((function (vec__13371,ns,vars__$1){
return (function (){
...
var G__13374 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__13374,G__13374__$1,env,once_fixtures,each_fixtures,vec__13371,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__13374,G__13374__$1,env,once_fixtures,each_fixtures,vec__13371,ns,vars__$1){
return (function (){
var seq__13375 = cljs.core.seq.call(null,vars__$1);
var chunk__13376 = null;
var count__13377 = (0);
var i__13378 = (0);
while(true){
if((i__13378 < count__13377)){
var v = cljs.core._nth.call(null,chunk__13376,i__13378);
var temp__5457__auto___13380 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___13380)){
var t_13381 = temp__5457__auto___13380;
each_fixture_fn.call(null,((function (seq__13375,chunk__13376,count__13377,i__13378,t_13381,temp__5457__auto___13380,v,each_fixture_fn,G__13374,G__13374__$1,env,once_fixtures,each_fixtures,vec__13371,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_13381)));
});})(seq__13375,chunk__13376,count__13377,i__13378,t_13381,temp__5457__auto___13380,v,each_fixture_fn,G__13374,G__13374__$1,env,once_fixtures,each_fixtures,vec__13371,ns,vars__$1))
);
} else {
}


var G__13382 = seq__13375;
var G__13383 = chunk__13376;
var G__13384 = count__13377;
var G__13385 = (i__13378 + (1));
seq__13375 = G__13382;
chunk__13376 = G__13383;
count__13377 = G__13384;
i__13378 = G__13385;
continue;
} else {
var temp__5457__auto__ = cljs.core.seq.call(null,seq__13375);
if(temp__5457__auto__){
var seq__13375__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__13375__$1)){
var c__4351__auto__ = cljs.core.chunk_first.call(null,seq__13375__$1);
var G__13386 = cljs.core.chunk_rest.call(null,seq__13375__$1);
var G__13387 = c__4351__auto__;
var G__13388 = cljs.core.count.call(null,c__4351__auto__);
var G__13389 = (0);
seq__13375 = G__13386;
chunk__13376 = G__13387;
count__13377 = G__13388;
i__13378 = G__13389;
continue;
} else {
var v = cljs.core.first.call(null,seq__13375__$1);
var temp__5457__auto___13390__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5457__auto___13390__$1)){
var t_13391 = temp__5457__auto___13390__$1;
each_fixture_fn.call(null,((function (seq__13375,chunk__13376,count__13377,i__13378,t_13391,temp__5457__auto___13390__$1,v,seq__13375__$1,temp__5457__auto__,each_fixture_fn,G__13374,G__13374__$1,env,once_fixtures,each_fixtures,vec__13371,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_13391)));
});})(seq__13375,chunk__13376,count__13377,i__13378,t_13391,temp__5457__auto___13390__$1,v,seq__13375__$1,temp__5457__auto__,each_fixture_fn,G__13374,G__13374__$1,env,once_fixtures,each_fixtures,vec__13371,ns,vars__$1))
);
} else {
}


var G__13392 = cljs.core.next.call(null,seq__13375__$1);
var G__13393 = null;
var G__13394 = (0);
var G__13395 = (0);
seq__13375 = G__13392;
chunk__13376 = G__13393;
count__13377 = G__13394;
i__13378 = G__13395;
continue;
}
} else {
...
});})(each_fixture_fn,G__13374,G__13374__$1,env,once_fixtures,each_fixtures,vec__13371,ns,vars__$1))
);
});})(each_fixture_fn,G__13374,G__13374__$1,env,once_fixtures,each_fixtures,vec__13371,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__13374__$1)].join('')));

}
})());
});
;})(vec__13371,ns,vars__$1))
