...
var G__9707 = o;
(G__9707[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__9709__i < G__9709__a.length) {G__9709__a[G__9709__i] = arguments[G__9709__i + 0]; ++G__9709__i;}
  args = new cljs.core.IndexedSeq(G__9709__a,0,null);
} 
...
var G__9711 = o;
(G__9711[reagent.impl.template.cached_custom_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__9716 = props;
var G__9716__$1 = ((((!((id == null))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__9716,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__9716);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__9716__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__9717){
...
var props = map__9718__$1;
var class$ = cljs.core.get.call(null,map__9718__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_.call(null,class$)){
return cljs.core.assoc.call(null,props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",cljs.core.keep.call(null,((function (map__9718,map__9718__$1,props,class$){
return (function (c){
...
});})(map__9718,map__9718__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__9720){
...
var on_write = cljs.core.get.call(null,map__9721__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__9721,map__9721__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__9721,map__9721__$1,on_write))
);
} else {
...
var G__9724 = jsprops;
(G__9724["defaultValue"] = value);

(G__9724["onChange"] = ((function (G__9724,v,value,on_change){
return (function (p1__9723_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__9723_SHARP_);
});})(G__9724,v,value,on_change))
);
...
var vec__9727 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__9727,(0),null);
var id = cljs.core.nth.call(null,vec__9727,(1),null);
var class$ = cljs.core.nth.call(null,vec__9727,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___9731 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5461__auto___9731 == null)){
} else {
var key_9732 = temp__5461__auto___9731;
(jsprops["key"] = key_9732);
}
...
var temp__5461__auto___9733 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5461__auto___9733 == null)){
} else {
var key_9734 = temp__5461__auto___9733;
reagent.impl.template.oset.call(null,jsprops,"key",key_9734);
}
...
var G__9735 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__9735["name"] = c);
...
var len__4531__auto___9740 = arguments.length;
var i__4532__auto___9741 = (0);
while(true){
if((i__4532__auto___9741 < len__4531__auto___9740)){
args__4534__auto__.push((arguments[i__4532__auto___9741]));

var G__9742 = (i__4532__auto___9741 + (1));
i__4532__auto___9741 = G__9742;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq9738){
var G__9739 = cljs.core.first.call(null,seq9738);
var seq9738__$1 = cljs.core.next.call(null,seq9738);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__9739,seq9738__$1);
});
...
break;
default:
var G__9745 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__9745;
continue;
...
var n__4408__auto___9747 = a.length;
var i_9748 = (0);
while(true){
if((i_9748 < n__4408__auto___9747)){
(a[i_9748] = reagent.impl.template.as_element.call(null,(a[i_9748])));
...
var a = cljs.core.into_array.call(null,s);
var n__4408__auto___9750 = a.length;
var i_9751 = (0);
while(true){
if((i_9751 < n__4408__auto___9750)){
var val_9752 = (a[i_9751]);
if(((cljs.core.vector_QMARK_.call(null,val_9752)) && ((reagent.impl.template.key_from_vec.call(null,val_9752) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_9751] = reagent.impl.template.as_element.call(null,val_9752));
...
var ctx = ({});
var vec__9754 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__9754,(0),null);
var derefed = cljs.core.nth.call(null,vec__9754,(1),null);
...
var G__9757 = (cljs.core.count.call(null,argv) - first_child);
switch (G__9757) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__9757){
