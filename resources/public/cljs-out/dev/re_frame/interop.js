...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__9965 = cljs.core.instance_QMARK_;
var expr__9966 = reactive_val;
if(cljs.core.truth_(pred__9965.call(null,reagent.ratom.RAtom,expr__9966))){
return "ra";
} else {
if(cljs.core.truth_(pred__9965.call(null,reagent.ratom.RCursor,expr__9966))){
return "rc";
} else {
if(cljs.core.truth_(pred__9965.call(null,reagent.ratom.Reaction,expr__9966))){
return "rx";
} else {
if(cljs.core.truth_(pred__9965.call(null,reagent.ratom.Track,expr__9966))){
return "tr";
} else {
return "other";
}
