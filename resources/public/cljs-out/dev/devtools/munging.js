...
var o20871 = temp__5455__auto__;
var temp__5455__auto____$1 = (o20871["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o20872 = temp__5455__auto____$1;
return (o20872["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__20691__auto__ = f;
return (o__20691__auto__["toString"]).call(o__20691__auto__);
} else {
return "";
}
}catch (e20873){var _ = e20873;
return "";
}});
...
try{var o__20691__auto___20875 = t;
(o__20691__auto___20875["cljs$lang$ctorPrWriter"]).call(o__20691__auto___20875,t,writer);
}catch (e20874){var __20876 = e20874;
}
...
var char_code = (function (){var o__20691__auto__ = (new String(char$));
return (o__20691__auto__["charCodeAt"]).call(o__20691__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__20691__auto__ = String;
return (o__20691__auto__["fromCharCode"]).call(o__20691__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__20877 = num_code;
switch (G__20877) {
case (1):
return (185);
...
var o__20691__auto__ = String;
return (o__20691__auto__["fromCharCode"]).call(o__20691__auto__,superscript_code);
});
/**
...
}catch (e20879){var _e__20698__auto__ = e20879;
return false;
}})())){
...
var vec__20880 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__20880,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o20883 = temp__5455__auto__;
var temp__5455__auto____$1 = (o20883["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o20884 = temp__5455__auto____$1;
return (o20884["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__20887){
var vec__20888 = p__20887;
var ns_detector = cljs.core.nth.call(null,vec__20888,(0),null);
...
var G__20894 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__20895 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__20894;
remaining_tokens = G__20895;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq20885){
var G__20886 = cljs.core.first.call(null,seq20885);
var seq20885__$1 = cljs.core.next.call(null,seq20885);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__20886,seq20885__$1);
});
...
var vec__20899 = cljs.core.split_with.call(null,(function (p1__20898_SHARP_){
return cljs.core.not_EQ_.call(null,p1__20898_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__20899,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__20899,(1),null);
...
var vec__20902 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__20902,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__20902,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__20905 = cljs.core.rest.call(null,remaining_tokens);
var G__20906 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__20905;
name_tokens = G__20906;
continue;
} else {
...
var vec__20909 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__20909,(0),null);
var arity = cljs.core.nth.call(null,vec__20909,(1),null);
var vec__20912 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__20912,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__20912,(1),null);
var vec__20915 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__20915,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__20915,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__20915,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__20915,(3),null);
...
var vec__20921 = result;
var munged_ns = cljs.core.nth.call(null,vec__20921,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__20921,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__20921,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__20921,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__20921,(4),null);
var arity = cljs.core.nth.call(null,vec__20921,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__20925 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__20925,(0),null);
var args = cljs.core.nth.call(null,vec__20925,(1),null);
var vec__20928 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__20928,(0),null);
var name = cljs.core.nth.call(null,vec__20928,(1),null);
...
var G__20931 = (arity + (1));
var G__20932 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__20933){
var vec__20934 = p__20933;
var arity = cljs.core.nth.call(null,vec__20934,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__20934,(1),null);
...
return cljs.core.get.call(null,arities,p1__20937_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__20938_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__20941){
var vec__20942 = p__20941;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__20942,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq20939){
var G__20940 = cljs.core.first.call(null,seq20939);
var seq20939__$1 = cljs.core.next.call(null,seq20939);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__20940,seq20939__$1);
});
...
var map__20950 = options;
var map__20950__$1 = ((((!((map__20950 == null)))?(((((map__20950.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__20950.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__20950):map__20950);
var include_ns_QMARK_ = cljs.core.get.call(null,map__20950__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__20950__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__20950__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__20950__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__20951 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__20951,(0),null);
var fn_name = cljs.core.nth.call(null,vec__20951,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__20951,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__20951,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__20951,(4),null);
var arity = cljs.core.nth.call(null,vec__20951,(5),null);
...
var o__20691__auto__ = f;
return (o__20691__auto__["getBasis"]).call(o__20691__auto__);
});
/**
...
}catch (e20955){var _e__20698__auto__ = e20955;
...
var G__20956 = (obj[cljs.core.first.call(null,path)]);
var G__20957 = cljs.core.rest.call(null,path);
obj = G__20956;
path = G__20957;
continue;
} else {
...
return (function (accum,p__20958){
var vec__20959 = p__20958;
var bit = cljs.core.nth.call(null,vec__20959,(0),null);
var protocol = cljs.core.nth.call(null,vec__20959,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__20962){
var vec__20963 = p__20962;
var ns = cljs.core.nth.call(null,vec__20963,(0),null);
var name = cljs.core.nth.call(null,vec__20963,(1),null);
var selector = cljs.core.nth.call(null,vec__20963,(2),null);
...
return (function (p__20967){
var vec__20968 = p__20967;
var munged_name = cljs.core.nth.call(null,vec__20968,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__20968,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__20968,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__20966_SHARP_){
return (obj[cljs.core.first.call(null,p1__20966_SHARP_)]);
});})(name,sorted_matches,vec__20968,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
