...
var o14016 = temp__5455__auto__;
var temp__5455__auto____$1 = (o14016["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o14017 = temp__5455__auto____$1;
return (o14017["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__13836__auto__ = f;
return (o__13836__auto__["toString"]).call(o__13836__auto__);
} else {
return "";
}
}catch (e14018){var _ = e14018;
return "";
}});
...
try{var o__13836__auto___14020 = t;
(o__13836__auto___14020["cljs$lang$ctorPrWriter"]).call(o__13836__auto___14020,t,writer);
}catch (e14019){var __14021 = e14019;
}
...
var char_code = (function (){var o__13836__auto__ = (new String(char$));
return (o__13836__auto__["charCodeAt"]).call(o__13836__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__13836__auto__ = String;
return (o__13836__auto__["fromCharCode"]).call(o__13836__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__14022 = num_code;
switch (G__14022) {
case (1):
return (185);
...
var o__13836__auto__ = String;
return (o__13836__auto__["fromCharCode"]).call(o__13836__auto__,superscript_code);
});
/**
...
}catch (e14024){var _e__13843__auto__ = e14024;
return false;
}})())){
...
var vec__14025 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__14025,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o14028 = temp__5455__auto__;
var temp__5455__auto____$1 = (o14028["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o14029 = temp__5455__auto____$1;
return (o14029["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__14032){
var vec__14033 = p__14032;
var ns_detector = cljs.core.nth.call(null,vec__14033,(0),null);
...
var G__14039 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__14040 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__14039;
remaining_tokens = G__14040;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq14030){
...
var vec__14044 = cljs.core.split_with.call(null,(function (p1__14043_SHARP_){
return cljs.core.not_EQ_.call(null,p1__14043_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__14044,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__14044,(1),null);
...
var vec__14047 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__14047,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__14047,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__14050 = cljs.core.rest.call(null,remaining_tokens);
var G__14051 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__14050;
name_tokens = G__14051;
continue;
} else {
...
var vec__14054 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__14054,(0),null);
var arity = cljs.core.nth.call(null,vec__14054,(1),null);
var vec__14057 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__14057,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__14057,(1),null);
var vec__14060 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__14060,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__14060,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__14060,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__14060,(3),null);
...
var vec__14066 = result;
var munged_ns = cljs.core.nth.call(null,vec__14066,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__14066,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__14066,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__14066,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__14066,(4),null);
var arity = cljs.core.nth.call(null,vec__14066,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__14070 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__14070,(0),null);
var args = cljs.core.nth.call(null,vec__14070,(1),null);
var vec__14073 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__14073,(0),null);
var name = cljs.core.nth.call(null,vec__14073,(1),null);
...
var G__14076 = (arity + (1));
var G__14077 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__14078){
var vec__14079 = p__14078;
var arity = cljs.core.nth.call(null,vec__14079,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__14079,(1),null);
...
return cljs.core.get.call(null,arities,p1__14082_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__14083_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__14086){
var vec__14087 = p__14086;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__14087,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq14084){
var G__14085 = cljs.core.first.call(null,seq14084);
var seq14084__$1 = cljs.core.next.call(null,seq14084);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__14085,seq14084__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__14095__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__14095__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__14095__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__14095__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__14096 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__14096,(0),null);
var fn_name = cljs.core.nth.call(null,vec__14096,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__14096,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__14096,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__14096,(4),null);
...
var o__13836__auto__ = f;
return (o__13836__auto__["getBasis"]).call(o__13836__auto__);
});
/**
...
}catch (e14100){var _e__13843__auto__ = e14100;
...
var G__14101 = (obj[cljs.core.first.call(null,path)]);
var G__14102 = cljs.core.rest.call(null,path);
obj = G__14101;
path = G__14102;
continue;
} else {
...
return (function (accum,p__14103){
var vec__14104 = p__14103;
var bit = cljs.core.nth.call(null,vec__14104,(0),null);
var protocol = cljs.core.nth.call(null,vec__14104,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__14107){
var vec__14108 = p__14107;
var ns = cljs.core.nth.call(null,vec__14108,(0),null);
var name = cljs.core.nth.call(null,vec__14108,(1),null);
var selector = cljs.core.nth.call(null,vec__14108,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__14113,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__14113,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__14113,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__14111_SHARP_){
return (obj[cljs.core.first.call(null,p1__14111_SHARP_)]);
});})(name,sorted_matches,vec__14113,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
