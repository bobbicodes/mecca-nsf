...
var o20856 = temp__5455__auto__;
var temp__5455__auto____$1 = (o20856["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o20857 = temp__5455__auto____$1;
return (o20857["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
try{var o__20676__auto___20860 = t;
(o__20676__auto___20860["cljs$lang$ctorPrWriter"]).call(o__20676__auto___20860,t,writer);
}catch (e20859){var __20861 = e20859;
}
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__20862 = num_code;
switch (G__20862) {
case (1):
return (185);
...
}catch (e20864){var _e__20683__auto__ = e20864;
return false;
}})())){
...
var vec__20865 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__20865,(0),null);
...
var temp__5455__auto____$1 = (o20868["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o20869 = temp__5455__auto____$1;
return (o20869["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4531__auto___20876 = arguments.length;
var i__4532__auto___20877 = (0);
while(true){
if((i__4532__auto___20877 < len__4531__auto___20876)){
args__4534__auto__.push((arguments[i__4532__auto___20877]));

var G__20878 = (i__4532__auto___20877 + (1));
i__4532__auto___20877 = G__20878;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__20872){
var vec__20873 = p__20872;
var ns_detector = cljs.core.nth.call(null,vec__20873,(0),null);
...
var G__20879 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__20880 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__20879;
remaining_tokens = G__20880;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq20870){
var G__20871 = cljs.core.first.call(null,seq20870);
var seq20870__$1 = cljs.core.next.call(null,seq20870);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__20871,seq20870__$1);
});
...
var vec__20884 = cljs.core.split_with.call(null,(function (p1__20883_SHARP_){
return cljs.core.not_EQ_.call(null,p1__20883_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__20884,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__20884,(1),null);
...
var vec__20887 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__20887,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__20887,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__20890 = cljs.core.rest.call(null,remaining_tokens);
var G__20891 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__20890;
...
var vec__20894 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__20894,(0),null);
var arity = cljs.core.nth.call(null,vec__20894,(1),null);
var vec__20897 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__20897,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__20897,(1),null);
var vec__20900 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__20900,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__20900,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__20900,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__20900,(3),null);
...
var vec__20906 = result;
var munged_ns = cljs.core.nth.call(null,vec__20906,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__20906,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__20906,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__20906,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__20906,(4),null);
var arity = cljs.core.nth.call(null,vec__20906,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__20910 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__20910,(0),null);
var args = cljs.core.nth.call(null,vec__20910,(1),null);
var vec__20913 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__20913,(0),null);
...
var G__20916 = (arity + (1));
var G__20917 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__20918){
var vec__20919 = p__20918;
var arity = cljs.core.nth.call(null,vec__20919,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__20919,(1),null);
...
return cljs.core.get.call(null,arities,p1__20922_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__20923_SHARP_);
...
var args__4534__auto__ = [];
var len__4531__auto___20930 = arguments.length;
var i__4532__auto___20931 = (0);
while(true){
if((i__4532__auto___20931 < len__4531__auto___20930)){
args__4534__auto__.push((arguments[i__4532__auto___20931]));

var G__20932 = (i__4532__auto___20931 + (1));
i__4532__auto___20931 = G__20932;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__20926){
var vec__20927 = p__20926;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__20927,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq20924){
var G__20925 = cljs.core.first.call(null,seq20924);
var seq20924__$1 = cljs.core.next.call(null,seq20924);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__20925,seq20924__$1);
});
...
var G__20933 = arg;
var G__20933__$1 = (((G__20933 instanceof cljs.core.Keyword))?G__20933.fqn:null);
switch (G__20933__$1) {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__20935__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__20935__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__20935__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__20935__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__20936 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__20936,(0),null);
var fn_name = cljs.core.nth.call(null,vec__20936,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__20936,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__20936,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__20936,(4),null);
var arity = cljs.core.nth.call(null,vec__20936,(5),null);
...
}catch (e20940){var _e__20683__auto__ = e20940;
...
var G__20941 = (obj[cljs.core.first.call(null,path)]);
var G__20942 = cljs.core.rest.call(null,path);
obj = G__20941;
path = G__20942;
continue;
} else {
...
return (function (accum,p__20943){
var vec__20944 = p__20943;
var bit = cljs.core.nth.call(null,vec__20944,(0),null);
var protocol = cljs.core.nth.call(null,vec__20944,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__20947){
var vec__20948 = p__20947;
var ns = cljs.core.nth.call(null,vec__20948,(0),null);
var name = cljs.core.nth.call(null,vec__20948,(1),null);
var selector = cljs.core.nth.call(null,vec__20948,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__20953,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__20953,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__20953,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__20951_SHARP_){
return (obj[cljs.core.first.call(null,p1__20951_SHARP_)]);
});})(name,sorted_matches,vec__20953,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
