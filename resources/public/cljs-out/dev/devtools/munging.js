...
var o14015 = temp__5455__auto__;
var temp__5455__auto____$1 = (o14015["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o14016 = temp__5455__auto____$1;
return (o14016["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__13835__auto__ = f;
return (o__13835__auto__["toString"]).call(o__13835__auto__);
} else {
return "";
}
}catch (e14017){var _ = e14017;
return "";
}});
...
try{var o__13835__auto___14019 = t;
(o__13835__auto___14019["cljs$lang$ctorPrWriter"]).call(o__13835__auto___14019,t,writer);
}catch (e14018){var __14020 = e14018;
}
...
var char_code = (function (){var o__13835__auto__ = (new String(char$));
return (o__13835__auto__["charCodeAt"]).call(o__13835__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__13835__auto__ = String;
return (o__13835__auto__["fromCharCode"]).call(o__13835__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__14021 = num_code;
switch (G__14021) {
case (1):
return (185);
...
var o__13835__auto__ = String;
return (o__13835__auto__["fromCharCode"]).call(o__13835__auto__,superscript_code);
});
/**
...
}catch (e14023){var _e__13842__auto__ = e14023;
return false;
}})())){
...
var vec__14024 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__14024,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o14027 = temp__5455__auto__;
var temp__5455__auto____$1 = (o14027["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o14028 = temp__5455__auto____$1;
return (o14028["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__14031){
var vec__14032 = p__14031;
var ns_detector = cljs.core.nth.call(null,vec__14032,(0),null);
...
var G__14038 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__14039 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__14038;
remaining_tokens = G__14039;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq14029){
...
var vec__14043 = cljs.core.split_with.call(null,(function (p1__14042_SHARP_){
return cljs.core.not_EQ_.call(null,p1__14042_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__14043,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__14043,(1),null);
...
var vec__14046 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__14046,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__14046,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__14049 = cljs.core.rest.call(null,remaining_tokens);
var G__14050 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__14049;
name_tokens = G__14050;
continue;
} else {
...
var vec__14053 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__14053,(0),null);
var arity = cljs.core.nth.call(null,vec__14053,(1),null);
var vec__14056 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__14056,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__14056,(1),null);
var vec__14059 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__14059,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__14059,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__14059,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__14059,(3),null);
...
var vec__14065 = result;
var munged_ns = cljs.core.nth.call(null,vec__14065,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__14065,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__14065,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__14065,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__14065,(4),null);
var arity = cljs.core.nth.call(null,vec__14065,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__14069 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__14069,(0),null);
var args = cljs.core.nth.call(null,vec__14069,(1),null);
var vec__14072 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__14072,(0),null);
var name = cljs.core.nth.call(null,vec__14072,(1),null);
...
var G__14075 = (arity + (1));
var G__14076 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__14077){
var vec__14078 = p__14077;
var arity = cljs.core.nth.call(null,vec__14078,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__14078,(1),null);
...
return cljs.core.get.call(null,arities,p1__14081_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__14082_SHARP_);
...
var args__4534__auto__ = [];
var len__4531__auto___14089 = arguments.length;
var i__4532__auto___14090 = (0);
while(true){
if((i__4532__auto___14090 < len__4531__auto___14089)){
args__4534__auto__.push((arguments[i__4532__auto___14090]));

var G__14091 = (i__4532__auto___14090 + (1));
i__4532__auto___14090 = G__14091;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__14085){
var vec__14086 = p__14085;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__14086,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq14083){
var G__14084 = cljs.core.first.call(null,seq14083);
var seq14083__$1 = cljs.core.next.call(null,seq14083);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__14084,seq14083__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__14094__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__14094__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__14094__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__14094__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__14095 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__14095,(0),null);
var fn_name = cljs.core.nth.call(null,vec__14095,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__14095,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__14095,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__14095,(4),null);
var arity = cljs.core.nth.call(null,vec__14095,(5),null);
...
var o__13835__auto__ = f;
return (o__13835__auto__["getBasis"]).call(o__13835__auto__);
});
/**
...
}catch (e14099){var _e__13842__auto__ = e14099;
...
var G__14100 = (obj[cljs.core.first.call(null,path)]);
var G__14101 = cljs.core.rest.call(null,path);
obj = G__14100;
path = G__14101;
continue;
} else {
...
return (function (accum,p__14102){
var vec__14103 = p__14102;
var bit = cljs.core.nth.call(null,vec__14103,(0),null);
var protocol = cljs.core.nth.call(null,vec__14103,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__14106){
var vec__14107 = p__14106;
var ns = cljs.core.nth.call(null,vec__14107,(0),null);
var name = cljs.core.nth.call(null,vec__14107,(1),null);
var selector = cljs.core.nth.call(null,vec__14107,(2),null);
...
return (function (p__14111){
var vec__14112 = p__14111;
var munged_name = cljs.core.nth.call(null,vec__14112,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__14112,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__14112,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__14110_SHARP_){
return (obj[cljs.core.first.call(null,p1__14110_SHARP_)]);
});})(name,sorted_matches,vec__14112,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
