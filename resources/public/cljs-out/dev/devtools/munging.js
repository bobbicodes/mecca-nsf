...
var o20868 = temp__5455__auto__;
var temp__5455__auto____$1 = (o20868["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o20869 = temp__5455__auto____$1;
return (o20869["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
try{var o__20688__auto___20872 = t;
(o__20688__auto___20872["cljs$lang$ctorPrWriter"]).call(o__20688__auto___20872,t,writer);
}catch (e20871){var __20873 = e20871;
}
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__20874 = num_code;
switch (G__20874) {
case (1):
return (185);
...
}catch (e20876){var _e__20695__auto__ = e20876;
return false;
}})())){
...
var vec__20877 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__20877,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o20880 = temp__5455__auto__;
var temp__5455__auto____$1 = (o20880["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o20881 = temp__5455__auto____$1;
return (o20881["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4531__auto___20888 = arguments.length;
var i__4532__auto___20889 = (0);
while(true){
if((i__4532__auto___20889 < len__4531__auto___20888)){
args__4534__auto__.push((arguments[i__4532__auto___20889]));

var G__20890 = (i__4532__auto___20889 + (1));
i__4532__auto___20889 = G__20890;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__20884){
var vec__20885 = p__20884;
var ns_detector = cljs.core.nth.call(null,vec__20885,(0),null);
...
var G__20891 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__20892 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__20891;
remaining_tokens = G__20892;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq20882){
var G__20883 = cljs.core.first.call(null,seq20882);
var seq20882__$1 = cljs.core.next.call(null,seq20882);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__20883,seq20882__$1);
});
...
var vec__20896 = cljs.core.split_with.call(null,(function (p1__20895_SHARP_){
return cljs.core.not_EQ_.call(null,p1__20895_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__20896,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__20896,(1),null);
...
var vec__20899 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__20899,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__20899,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__20902 = cljs.core.rest.call(null,remaining_tokens);
var G__20903 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__20902;
name_tokens = G__20903;
continue;
} else {
...
var vec__20906 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__20906,(0),null);
var arity = cljs.core.nth.call(null,vec__20906,(1),null);
var vec__20909 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__20909,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__20909,(1),null);
var vec__20912 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__20912,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__20912,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__20912,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__20912,(3),null);
...
var vec__20918 = result;
var munged_ns = cljs.core.nth.call(null,vec__20918,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__20918,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__20918,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__20918,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__20918,(4),null);
var arity = cljs.core.nth.call(null,vec__20918,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__20922 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__20922,(0),null);
var args = cljs.core.nth.call(null,vec__20922,(1),null);
var vec__20925 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__20925,(0),null);
var name = cljs.core.nth.call(null,vec__20925,(1),null);
...
var G__20928 = (arity + (1));
var G__20929 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__20930){
var vec__20931 = p__20930;
var arity = cljs.core.nth.call(null,vec__20931,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__20931,(1),null);
...
return cljs.core.get.call(null,arities,p1__20934_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__20935_SHARP_);
...
var args__4534__auto__ = [];
var len__4531__auto___20942 = arguments.length;
var i__4532__auto___20943 = (0);
while(true){
if((i__4532__auto___20943 < len__4531__auto___20942)){
args__4534__auto__.push((arguments[i__4532__auto___20943]));

var G__20944 = (i__4532__auto___20943 + (1));
i__4532__auto___20943 = G__20944;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__20938){
var vec__20939 = p__20938;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__20939,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq20936){
var G__20937 = cljs.core.first.call(null,seq20936);
var seq20936__$1 = cljs.core.next.call(null,seq20936);
var self__4518__auto__ = this;
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__20937,seq20936__$1);
});
...
var map__20947 = options;
var map__20947__$1 = ((((!((map__20947 == null)))?(((((map__20947.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__20947.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__20947):map__20947);
var include_ns_QMARK_ = cljs.core.get.call(null,map__20947__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__20947__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__20947__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__20947__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__20948 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__20948,(0),null);
var fn_name = cljs.core.nth.call(null,vec__20948,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__20948,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__20948,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__20948,(4),null);
var arity = cljs.core.nth.call(null,vec__20948,(5),null);
...
}catch (e20952){var _e__20695__auto__ = e20952;
...
var G__20953 = (obj[cljs.core.first.call(null,path)]);
var G__20954 = cljs.core.rest.call(null,path);
obj = G__20953;
path = G__20954;
continue;
} else {
...
return (function (accum,p__20955){
var vec__20956 = p__20955;
var bit = cljs.core.nth.call(null,vec__20956,(0),null);
var protocol = cljs.core.nth.call(null,vec__20956,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__20959){
var vec__20960 = p__20959;
var ns = cljs.core.nth.call(null,vec__20960,(0),null);
var name = cljs.core.nth.call(null,vec__20960,(1),null);
var selector = cljs.core.nth.call(null,vec__20960,(2),null);
...
return (function (p__20964){
var vec__20965 = p__20964;
var munged_name = cljs.core.nth.call(null,vec__20965,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__20965,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__20965,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__20963_SHARP_){
return (obj[cljs.core.first.call(null,p1__20963_SHARP_)]);
});})(name,sorted_matches,vec__20965,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
