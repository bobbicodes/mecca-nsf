...
var line = cljs.core.get.call(null,map__25755__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__25755__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e25754){var _e = e25754;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5455__auto___25757 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5455__auto___25757)){
var seen_errors_25758 = temp__5455__auto___25757;
if(cljs.core.truth_(seen_errors_25758.has(self))){
} else {
seen_errors_25758.add(self);

var temp__5457__auto___25759 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5457__auto___25759)){
var sense_25760 = temp__5457__auto___25759;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_25760)].join('');
} else {
}
}
} else {
