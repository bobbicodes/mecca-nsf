...
var G__21444 = devtools.prefs.pref.call(null,v);
v = G__21444;
continue;
} else {
return v;
...
}catch (e21447){var _e__20698__auto__ = e21447;
return false;
}})();
...
}catch (e21451){var _e__20698__auto__ = e21451;
return false;
}})();
...
}catch (e21453){var _e__20698__auto__ = e21453;
return false;
}}
}
});
...
var vec__21455 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__21455,(0),null);
var name = cljs.core.nth.call(null,vec__21455,(1),null);
...
return cljs.core.some.call(null,(function (p1__21458_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__21458_SHARP_);
}),template);
});
