...
var G__14589 = devtools.prefs.pref.call(null,v);
v = G__14589;
continue;
} else {
return v;
...
}catch (e14592){var _e__13843__auto__ = e14592;
return false;
}})();
...
}catch (e14596){var _e__13843__auto__ = e14596;
return false;
}})();
...
}catch (e14598){var _e__13843__auto__ = e14598;
return false;
}}
}
});
...
var vec__14600 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__14600,(0),null);
var name = cljs.core.nth.call(null,vec__14600,(1),null);
...
return cljs.core.some.call(null,(function (p1__14603_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__14603_SHARP_);
}),template);
});
