...
var G__21429 = devtools.prefs.pref.call(null,v);
v = G__21429;
continue;
} else {
return v;
...
}catch (e21432){var _e__20683__auto__ = e21432;
return false;
}})();
...
}catch (e21436){var _e__20683__auto__ = e21436;
return false;
}})();
...
}catch (e21438){var _e__20683__auto__ = e21438;
return false;
}}
}
});
...
var vec__21440 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__21440,(0),null);
var name = cljs.core.nth.call(null,vec__21440,(1),null);
...
return cljs.core.some.call(null,(function (p1__21443_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__21443_SHARP_);
}),template);
});
