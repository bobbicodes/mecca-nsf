...
var G__21441 = devtools.prefs.pref.call(null,v);
v = G__21441;
continue;
} else {
return v;
...
}catch (e21444){var _e__20695__auto__ = e21444;
return false;
}})();
...
}catch (e21448){var _e__20695__auto__ = e21448;
return false;
}})();
...
}catch (e21450){var _e__20695__auto__ = e21450;
return false;
}}
}
});
...
var vec__21452 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__21452,(0),null);
var name = cljs.core.nth.call(null,vec__21452,(1),null);
...
return cljs.core.some.call(null,(function (p1__21455_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__21455_SHARP_);
}),template);
});
