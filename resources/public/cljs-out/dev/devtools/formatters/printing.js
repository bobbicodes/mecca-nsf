...
var len__4531__auto___14635 = arguments.length;
var i__4532__auto___14636 = (0);
while(true){
if((i__4532__auto___14636 < len__4531__auto___14635)){
args__4534__auto__.push((arguments[i__4532__auto___14636]));

var G__14637 = (i__4532__auto___14636 + (1));
i__4532__auto___14636 = G__14637;
continue;
} else {
}
break;
...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq14632){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__14633,G__14634,seq14632__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__14638_SHARP_){
return !((cljs.core.meta.call(null,p1__14638_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__14639__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e14643){var _e__13843__auto__ = e14643;
return false;
}})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
}catch (e14645){var _e__13843__auto__ = e14645;
return false;
}}
})())){
...
var _STAR_current_state_STAR_14647 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__14648 = opts;
...
var markup_db = cljs.core.get.call(null,map__14648__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_14647;
}});
...
;
var temp__5455__auto___14652 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5455__auto___14652)){
var managed_print_level_14653 = temp__5455__auto___14652;
var _STAR_print_level_STAR_14651_14654 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_14653;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_14651_14654,managed_print_level_14653,temp__5455__auto___14652,writer,opts,job_fn){
return (function (p1__14650_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__14650_SHARP_,null);
});})(_STAR_print_level_STAR_14651_14654,managed_print_level_14653,temp__5455__auto___14652,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_14651_14654;
}} else {
job_fn.call(null);
}
