...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq21472){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21473,G__21474,seq21472__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__21478_SHARP_){
return !((cljs.core.meta.call(null,p1__21478_SHARP_) == null));
})))){
...
var map__21479 = opts;
var map__21479__$1 = ((((!((map__21479 == null)))?(((((map__21479.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__21479.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__21479):map__21479);
var markup_db = cljs.core.get.call(null,map__21479__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e21483){var _e__20683__auto__ = e21483;
return false;
}})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
}catch (e21485){var _e__20683__auto__ = e21485;
return false;
}}
})())){
...
var _STAR_current_state_STAR_21487 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__21488 = opts;
...
var markup_db = cljs.core.get.call(null,map__21488__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_21487;
}});
...
;
var temp__5455__auto___21492 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5455__auto___21492)){
var managed_print_level_21493 = temp__5455__auto___21492;
var _STAR_print_level_STAR_21491_21494 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_21493;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_21491_21494,managed_print_level_21493,temp__5455__auto___21492,writer,opts,job_fn){
return (function (p1__21490_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__21490_SHARP_,null);
});})(_STAR_print_level_STAR_21491_21494,managed_print_level_21493,temp__5455__auto___21492,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_21491_21494;
}} else {
job_fn.call(null);
}
