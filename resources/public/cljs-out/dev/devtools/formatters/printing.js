...
var len__4531__auto___21490 = arguments.length;
var i__4532__auto___21491 = (0);
while(true){
if((i__4532__auto___21491 < len__4531__auto___21490)){
args__4534__auto__.push((arguments[i__4532__auto___21491]));

var G__21492 = (i__4532__auto___21491 + (1));
i__4532__auto___21491 = G__21492;
continue;
} else {
}
break;
...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq21487){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21488,G__21489,seq21487__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__21493_SHARP_){
return !((cljs.core.meta.call(null,p1__21493_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__21494__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e21498){var _e__20698__auto__ = e21498;
return false;
}})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
}catch (e21500){var _e__20698__auto__ = e21500;
return false;
}}
})())){
...
var _STAR_current_state_STAR_21502 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__21503 = opts;
var map__21503__$1 = ((((!((map__21503 == null)))?(((((map__21503.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__21503.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__21503):map__21503);
var markup_db = cljs.core.get.call(null,map__21503__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_21502;
}});
...
;
var temp__5455__auto___21507 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5455__auto___21507)){
var managed_print_level_21508 = temp__5455__auto___21507;
var _STAR_print_level_STAR_21506_21509 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_21508;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_21506_21509,managed_print_level_21508,temp__5455__auto___21507,writer,opts,job_fn){
return (function (p1__21505_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__21505_SHARP_,null);
});})(_STAR_print_level_STAR_21506_21509,managed_print_level_21508,temp__5455__auto___21507,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_21506_21509;
}} else {
job_fn.call(null);
}
