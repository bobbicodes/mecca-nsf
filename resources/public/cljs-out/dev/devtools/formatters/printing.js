...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq21484){
...
return self__4518__auto__.cljs$core$IFn$_invoke$arity$variadic(G__21485,G__21486,seq21484__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__21490_SHARP_){
return !((cljs.core.meta.call(null,p1__21490_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__21491__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e21495){var _e__20695__auto__ = e21495;
return false;
}})();
if(cljs.core.truth_(or__3949__auto__)){
return or__3949__auto__;
...
}catch (e21497){var _e__20695__auto__ = e21497;
return false;
}}
})())){
...
var _STAR_current_state_STAR_21499 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__21500 = opts;
...
var markup_db = cljs.core.get.call(null,map__21500__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_21499;
}});
...
;
var temp__5455__auto___21504 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5455__auto___21504)){
var managed_print_level_21505 = temp__5455__auto___21504;
var _STAR_print_level_STAR_21503_21506 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_21505;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_21503_21506,managed_print_level_21505,temp__5455__auto___21504,writer,opts,job_fn){
return (function (p1__21502_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__21502_SHARP_,null);
});})(_STAR_print_level_STAR_21503_21506,managed_print_level_21505,temp__5455__auto___21504,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_21503_21506;
}} else {
job_fn.call(null);
}
